...
render_callout("지도 상의 행정동을 클릭하시면 하단에 맞춤형 진단 리포트가 생성됩니다.", "info")
...
try:
    ...
    render_callout("'BND_ADM_DONG_PG.shp' 파일과 연관 파일들이 같은 폴더에 있는지 확인 요망", "warning")
    map_loaded = False
